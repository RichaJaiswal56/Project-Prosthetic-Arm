...
void closeFinger(int finger){
  if(finger==LITTLE){servoLittleFinger.write(130);} // Little finger 
  else if(finger==RING){servoRingFinger.write(120);}// Ring finger
  else if(finger==MIDDLE){servoMiddleFinger.write(170);}// Middle finger
  else if(finger==INDEX){servoIndexFinger.write(110);}// Index finger
  else if(finger==THUMB){servoThumbFinger.write(80);}//Thumb finger
}
